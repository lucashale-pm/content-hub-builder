...
export const gamesradarTheme: Theme = {
  brand: "gamesradar",
  color: { accent: "#ff6600", rankingAccent: "#6bdd73", contributionIconSurface: "#f2f2f4", contributionProgressSurface: "#eceef0", surface: "#161616", text: "#ffffff", background: "#ffffff", ink: "#1a1a1a", muted: "#737373", border: "#e6e6e6", labelNews: "#008a80", labelAnalysis: "#7156c8", labelGuide: "#a85c00" },
