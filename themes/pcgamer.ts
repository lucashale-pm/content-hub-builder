...
export const pcgamerTheme: Theme = {
  brand: "pcgamer",
  color: { accent: "#e31b23", rankingAccent: "#e31b23", contributionAccent: "#b11f26", surface: "#111111", text: "#ffffff", background: "#ffffff", ink: "#1a1a1a", muted: "#737373", border: "#e6e6e6", labelNews: "#b11f26", labelAnalysis: "#6b55ab", labelGuide: "#9c5900" },
